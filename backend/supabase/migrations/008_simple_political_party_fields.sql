...
-- Simple version that should work with all PostgreSQL versions

-- Add political_party_name if it doesn't exist
ALTER TABLE public.congress_initiatives 
ADD COLUMN IF NOT EXISTS political_party_name TEXT;

-- Add political_party_short_name if it doesn't exist
ALTER TABLE public.congress_initiatives 
ADD COLUMN IF NOT EXISTS political_party_short_name TEXT;

-- Add political_party_confidence if it doesn't exist
ALTER TABLE public.congress_initiatives 
ADD COLUMN IF NOT EXISTS political_party_confidence TEXT;

-- Add political_party_method if it doesn't exist
ALTER TABLE public.congress_initiatives 
ADD COLUMN IF NOT EXISTS political_party_method TEXT;

-- Add political_party_color if it doesn't exist
ALTER TABLE public.congress_initiatives 
ADD COLUMN IF NOT EXISTS political_party_color TEXT;
...
ADD CONSTRAINT IF NOT EXISTS unique_initiative_party_relationship 
...
CREATE POLICY IF NOT EXISTS "Congress initiative parties are viewable by everyone" 
